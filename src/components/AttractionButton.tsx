    ...
    <div className="flex gap-8 justify-center w-full items-center">
      {isClient ? (
        <div className="flex relative w-full justify-center">
          ...
          >
            <p>Quero contratar</p>
            <div className="absolute -top-full -left-1/4 group-hover:left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-all duration-500 ease-in-out group-hover:visible group-hover:opacity-100 invisible opacity-0 hidden flex-col items-center justify-center w-full -z-10 lg:flex">
              <img
        ...
        <div className="flex w-full justify-center relative">
          <Button size="md" color="primary" className="h-fit group flex">
            ...
            <div className="absolute -top-full -right-1/4 transition-all duration-500 ease-in-out group-hover:right-1/2 transform translate-x-1/2 -translate-y-1/2 group-hover:visible group-hover:opacity-100 invisible opacity-0 hidden flex-col items-center justify-center w-full -z-10 lg:flex">
              <img
                src="/images/geto.png"
                alt="geto"
